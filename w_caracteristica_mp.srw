HA$PBExportHeader$w_caracteristica_mp.srw
$PBExportComments$Para seleccionar la materia prima
forward
global type w_caracteristica_mp from w_response
end type
type st_1 from statictext within w_caracteristica_mp
end type
type sle_1 from singlelineedit within w_caracteristica_mp
end type
type cb_aceptar from commandbutton within w_caracteristica_mp
end type
type cb_cancelar from commandbutton within w_caracteristica_mp
end type
type dw_1 from u_dw_application within w_caracteristica_mp
end type
type gb_1 from groupbox within w_caracteristica_mp
end type
type gb_2 from groupbox within w_caracteristica_mp
end type
end forward
...
global w_caracteristica_mp w_caracteristica_mp
...
on w_caracteristica_mp.destroy
call super::destroy
destroy(this.st_1)
destroy(this.sle_1)
...
event modified;of_filtro("de_caracteristica like '%"+text+"%'")
dw_1.SetFocus()
end event
...
If il_fila<=0 Then
	MessageBox("Advertencia!","Seleccione Matiz.",StopSign!)
	Return
End If
...
lo_param.il_vector[1]=dw_1.GetItemNumber(il_fila,"co_caracteristica")
...
integer width = 1143
integer height = 928
string dataobject = "d_caracteristica_mp"
boolean border = true
borderstyle borderstyle = stylelowered!
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "B$$HEX1$$fa00$$ENDHEX$$squeda caracteristica"
borderstyle borderstyle = stylelowered!
end type

HA$PBExportHeader$w_inf_referencia.srw
$PBExportComments$Para las medidas de las referencias
forward
global type w_inf_referencia from w_report
end type
type dw_head from u_dw_application within w_inf_referencia
end type
type dw_tiempo from u_dw_application within w_inf_referencia
end type
type dw_referencia from u_dw_application within w_inf_referencia
end type
type gb_1 from groupbox within w_inf_referencia
end type
type gb_2 from groupbox within w_inf_referencia
end type
type gb_referencia from u_gb_base within w_inf_referencia
end type
end forward
...
global w_inf_referencia w_inf_referencia
...
//////////////////////////////////////////////////////////////////////////
// Asigno el dw que se va a recuperar
// 
//////////////////////////////////////////////////////////////////////////
...
If IsValid(io_param) Then
	...
	dw_referencia.setItem(1,"co_diseno",io_param.il_vector[7])
	...
	ll_res=lo_comun.of_nombrediseno(il_fabrica /*long a_fabrica*/,&
	                                il_linea/*long a_linea*/,&
											  ...
											  il_talla/*long a_talla*/,&
											  il_calidad/*long a_calidad*/,&
											  io_param.il_vector[7]/*long a_diseno*/,&
											  n_cst_application.itr_appl/*transaction a_transaction */)
...
event ue_print;//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Miercoles 28 de Enero de 2004 HORA 17:50:13:483
// 
// 
//////////////////////////////////////////////////////////////////////////
MessageBox("Advertencia!","Se ha deshabilitado la opci$$HEX1$$f300$$ENDHEX$$n de imprimir.",StopSign!)
Return

end event

type dw_report from w_report`dw_report within w_inf_referencia
integer x = 9
integer y = 604
integer width = 3625
integer height = 1208
...
lds_1.DataObject="d_inf_det_ref1"
...
////////////////////////////////////////////////////////////////////////////
//// Calculo las cantidades teoricas
//// d_mv_maquinas_tj
////////////////////////////////////////////////////////////////////////////
//
//lds_1.DataObject="d_mv_maquinas_tj"
//
//lds_1.SetTransObject(n_cst_application.itr_appl)
//
//lds_1.Retrieve(io_param.il_vector[1],&
...
//					ll_maquina)
//Decimal{2} lde_teorico, lde_seg
//
//If lds_1.RowCount()>0 Then
//	lde_teorico=lds_1.GetItemDecimal(1,"produccion_teo")
//	lde_seg=3600*8/(lde_teorico*12)
//	Modify("doc_turno.text='"+String(lde_teorico)+"'")
//	Modify("teorico_seg.text='"+String(lde_seg)+"'")
//Else
////////////////////////////////////////////////////////////////////////////
//// Es posible que no se encuentre aca la teorica, entonces es necesario
//// buscarla en dt_maquinas_tj, para colocal el tiempo teorico de la ref
//// anterior
////////////////////////////////////////////////////////////////////////////
//	//
...
//	
//	lds_2.DataObject="d_dt_maquinas_tj"
//	
//	lds_2.SetTransObject(n_cst_application.itr_appl)
//	
//	lds_2.Retrieve(ll_maquina)
//	
//	If lds_2.RowCount()>0 Then
//		long ll_fabrica1,ll_linea1, ll_referencia1, ll_talla1, ll_calidad1
//		
//		ll_fabrica1 =lds_2.GetItemNumber(1,"co_fabrica")
//		ll_linea1=lds_2.GetItemNumber(1,"co_linea")
//		ll_referencia1=lds_2.GetItemNumber(1,"co_referencia")
//		ll_talla1=lds_2.GetItemNumber(1,"co_talla")
//		ll_calidad1=lds_2.GetItemNumber(1,"co_calidad")
//		
//		lds_1.Retrieve(ll_fabrica1,ll_linea1,ll_referencia1,ll_talla1,ll_calidad1,&
//		               io_param.il_vector[6],&
//					      ll_maquina)
//							
//		If lds_1.RowCount()>0 Then
...
//		Else
////////////////////////////////////////////////////////////////////////////
//// Si no se encuentra de esta forma, entonces en m_producc_teo...
//// 
////////////////////////////////////////////////////////////////////////////
//			lds_2.DataObject="d_m_producc_teo"
//			lds_2.SetTransObject(n_cst_application.itr_appl)
//			lds_2.Retrieve(io_param.il_vector[6],&
//			               io_param.il_vector[1],&
//								io_param.il_vector[2],&
//								io_param.il_vector[3],&
//								io_param.il_vector[4],&
//								io_.il_vector[5])
//								
//			If lds_2.RowCount()>0 Then
//				lde_teorico=lds_2.GetItemDecimal(1,"produccion_teo")
//				lde_seg=3600*8/(lde_teorico*12)
//				Modify("doc_turno.text='"+String(lde_teorico)+"'")
//				Modify("teorico_seg.text='"+String(lde_seg)+"'")				
//			End If

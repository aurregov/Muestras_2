HA$PBExportHeader$w_color_opcion.srw
$PBExportComments$Ventana para seleccionar el color y la opcion para la copia
forward
global type w_color_opcion from w_response
end type
type cb_2 from commandbutton within w_color_opcion
end type
type cb_1 from commandbutton within w_color_opcion
end type
type dw_1 from u_dw_application within w_color_opcion
end type
type gb_1 from groupbox within w_color_opcion
end type
end forward
...
global w_color_opcion w_color_opcion

on w_color_opcion.create
int iCurrent
call super::create
...
If IsValid(lo_param) Then
	...
	dw_1.SetItem(1,"opcion",lo_param.il_vector[2])
End If
...
lo_param.il_vector[2]=dw_1.GetItemnumber(1,"opcion")
...
integer width = 901
integer height = 176
string dataobject = "d_ext_color_opcion_select"

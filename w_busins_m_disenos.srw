HA$PBExportHeader$w_busins_m_disenos.srw
forward
global type w_busins_m_disenos from w_base_busqueda_mod
end type
end forward

global type w_busins_m_disenos from w_base_busqueda_mod
string title = "Dise$$HEX1$$f100$$ENDHEX$$os se referencia"
end type
global w_busins_m_disenos w_busins_m_disenos
...
on w_busins_m_disenos.create
call super::create
end on

on w_busins_m_disenos.destroy
call super::destroy
end on
...
type st_1 from w_base_busqueda_mod`st_1 within w_busins_m_disenos
string text = "Digite el dise$$HEX1$$f100$$ENDHEX$$o:"
end type

type sle_1 from w_base_busqueda_mod`sle_1 within w_busins_m_disenos
end type

event sle_1::modified;call super::modified;of_filtro("de_diseno like '%"+text+"%'")
end event

type cb_adicionar from w_base_busqueda_mod`cb_adicionar within w_busins_m_disenos
end type

type cb_eliminar from w_base_busqueda_mod`cb_eliminar within w_busins_m_disenos
end type

type cb_aceptar from w_base_busqueda_mod`cb_aceptar within w_busins_m_disenos
end type

type cb_cancelar from w_base_busqueda_mod`cb_cancelar within w_busins_m_disenos
end type

type dw_1 from w_base_busqueda_mod`dw_1 within w_busins_m_disenos
string dataobject = "d_listains_m_disenos"
end type
...
type gb_1 from w_base_busqueda_mod`gb_1 within w_busins_m_disenos
string text = "dise$$HEX1$$f100$$ENDHEX$$os de la referencia"
end type

type gb_2 from w_base_busqueda_mod`gb_2 within w_busins_m_disenos
string text = "B$$HEX1$$fa00$$ENDHEX$$squeda de dise$$HEX1$$f100$$ENDHEX$$os"
end type

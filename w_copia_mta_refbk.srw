HA$PBExportHeader$w_copia_mta_refbk.srw
$PBExportComments$Para hacer la copia de muestras a referencias
forward
global type w_copia_mta_refbk from w_sheet
end type
type dw_s_muestrario_color from u_dw_application within w_copia_mta_refbk
end type
type dw_s_precio_vta from u_dw_application within w_copia_mta_refbk
end type
type dw_dt_ref_vta from u_dw_application within w_copia_mta_refbk
end type
type tab_1 from tab within w_copia_mta_refbk
end type
...
type dw_head from u_dw_application within w_copia_mta_refbk
end type
type cbx_ft from checkbox within w_copia_mta_refbk
end type
type cbx_mo from checkbox within w_copia_mta_refbk
end type
type cbx_mp from checkbox within w_copia_mta_refbk
end type
type gb_2 from u_gb_base within w_copia_mta_refbk
end type
type gb_1 from u_gb_base within w_copia_mta_refbk
end type
end forward
...
global w_copia_mta_refbk w_copia_mta_refbk

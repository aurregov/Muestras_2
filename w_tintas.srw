HA$PBExportHeader$w_tintas.srw
$PBExportComments$Para seleccionar la materia prima
forward
global type w_tintas from w_response
end type
type st_1 from statictext within w_tintas
end type
type sle_1 from singlelineedit within w_tintas
end type
type cb_aceptar from commandbutton within w_tintas
end type
type cb_cancelar from commandbutton within w_tintas
end type
type dw_1 from u_dw_application within w_tintas
end type
type gb_1 from groupbox within w_tintas
end type
type gb_2 from groupbox within w_tintas
end type
end forward
...
integer width = 1673
integer height = 1528
string title = "Tintas Antideslizante"
st_1 st_1
sle_1 sle_1
...
event modified;of_filtro("de_tinta like '%"+text+"%'")
dw_1.SetFocus()
end event
...
If il_fila<=0 Then
	MessageBox("Advertencia!","Seleccione una tinta.",StopSign!)
	Return
End If
...
lo_param.il_vector[1]=dw_1.GetItemNumber(il_fila,"id_tinta")
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Tintas Antideslizante"
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "B$$HEX1$$fa00$$ENDHEX$$squeda de Tintas"
end type

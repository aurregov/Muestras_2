HA$PBExportHeader$w_actualiza_composicion.srw
$PBExportComments$Para actualizar la composicion de las referencias de venta
forward
global type w_actualiza_composicion from w_response
end type
type cb_2 from commandbutton within w_actualiza_composicion
end type
type cb_1 from commandbutton within w_actualiza_composicion
end type
type dw_1 from u_dw_application within w_actualiza_composicion
end type
type gb_1 from groupbox within w_actualiza_composicion
end type
end forward
...
integer width = 2674
integer height = 716
string title = "Composici$$HEX1$$f300$$ENDHEX$$n de referencia"
cb_2 cb_2
cb_1 cb_1
dw_1 dw_1
gb_1 gb_1
end type
global w_actualiza_composicion w_actualiza_composicion
...
on w_actualiza_composicion.create
int iCurrent
call super::create
...
on w_actualiza_composicion.destroy
call super::destroy
destroy(this.cb_2)
destroy(this.cb_1)
destroy(this.dw_1)
...
il_muestrario=lo_param.il_vector[6]
...
ll_res=dw_1.Retrieve(il_fabricaVta,il_lineaVta,il_referenciaVta,il_tallaVta,il_calidadVta)
...
integer width = 2514
integer height = 224
string dataobject = "d_composicion_referencia"
end type

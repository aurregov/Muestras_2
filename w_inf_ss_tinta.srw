HA$PBExportHeader$w_inf_ss_tinta.srw
$PBExportComments$solicitud de servicio de desarrollo hilaza y te$$HEX1$$f100$$ENDHEX$$ido hilaza
forward
global type w_inf_ss_tinta from w_report
end type
type cb_cancelar from u_cb_application within w_inf_ss_tinta
end type
type cb_print from u_cb_application within w_inf_ss_tinta
end type
type dw_dt_mu_ord from u_dw_application within w_inf_ss_tinta
end type
type gb_ss from u_gb_base within w_inf_ss_tinta
end type
end forward
...
integer width = 3579
integer height = 2188
string title = "Desarrollo Tinta Antideslizante"
string menuname = ""
...
global w_inf_ss_tinta w_inf_ss_tinta
...
type dw_report from w_report`dw_report within w_inf_ss_tinta
integer x = 82
integer y = 84
integer width = 3337
integer height = 1312
string dataobject = "d_inf_ss_tinta"
boolean border = true
...
integer height = 1424
integer taborder = 20
string text = "Desarrollo Tinta Antideslizante"
end type

HA$PBExportHeader$w_bus_talla_pdn.srw
forward
global type w_bus_talla_pdn from w_base_busqueda
end type
end forward

global type w_bus_talla_pdn from w_base_busqueda
string title = "B$$HEX1$$fa00$$ENDHEX$$squeda de tallas pdn"
end type
global w_bus_talla_pdn w_bus_talla_pdn
...
on w_bus_talla_pdn.create
call super::create
end on

on w_bus_talla_pdn.destroy
call super::destroy
end on
...
// recupera con fab-lin-ref 
dw_1.Retrieve(io_param.il_vector[1], io_param.il_vector[2], io_param.il_vector[3])
end event

type sle_1 from w_base_busqueda`sle_1 within w_bus_talla_pdn
end type
...
type st_1 from w_base_busqueda`st_1 within w_bus_talla_pdn
end type

type cb_aceptar from w_base_busqueda`cb_aceptar within w_bus_talla_pdn
end type

type cb_cancelar from w_base_busqueda`cb_cancelar within w_bus_talla_pdn
end type

type dw_1 from w_base_busqueda`dw_1 within w_bus_talla_pdn
string dataobject = "d_dddw_tallas_x_ref"
end type

type gb_1 from w_base_busqueda`gb_1 within w_bus_talla_pdn
string text = "Lista de Tallas"
end type

type gb_2 from w_base_busqueda`gb_2 within w_bus_talla_pdn
string text = "Talla pdn"
end type

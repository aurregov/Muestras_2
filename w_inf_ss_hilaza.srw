HA$PBExportHeader$w_inf_ss_hilaza.srw
$PBExportComments$solicitud de servicio de desarrollo hilaza y te$$HEX1$$f100$$ENDHEX$$ido hilaza
forward
global type w_inf_ss_hilaza from w_report
end type
type cb_cancelar from u_cb_application within w_inf_ss_hilaza
end type
type cb_print from u_cb_application within w_inf_ss_hilaza
end type
type dw_dt_mu_ord from u_dw_application within w_inf_ss_hilaza
end type
type gb_ss from u_gb_base within w_inf_ss_hilaza
end type
end forward
...
integer width = 3579
integer height = 2188
string title = "Desarrollo/Te$$HEX1$$f100$$ENDHEX$$ido hilaza"
string menuname = ""
...
global w_inf_ss_hilaza w_inf_ss_hilaza
...
type dw_report from w_report`dw_report within w_inf_ss_hilaza
integer x = 82
integer y = 108
integer width = 3337
integer height = 1312
string dataobject = "d_inf_ss_hilaza"
boolean border = true
...
integer height = 1424
integer taborder = 20
string text = "Desarrollo / Te$$HEX1$$f100$$ENDHEX$$ido Hilaza"
end type

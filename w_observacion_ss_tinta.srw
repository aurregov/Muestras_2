HA$PBExportHeader$w_observacion_ss_tinta.srw
$PBExportComments$Para el registro de la observacion de las solicitudes de servicio
forward
global type w_observacion_ss_tinta from w_response
end type
type st_1 from statictext within w_observacion_ss_tinta
end type
type mle_observacion from multilineedit within w_observacion_ss_tinta
end type
type cb_cancelar from commandbutton within w_observacion_ss_tinta
end type
type cb_aceptar from commandbutton within w_observacion_ss_tinta
end type
type dw_complemento from u_dw_application within w_observacion_ss_tinta
end type
type dw_observacion from u_dw_application within w_observacion_ss_tinta
end type
type gb_1 from groupbox within w_observacion_ss_tinta
end type
end forward
...
global w_observacion_ss_tinta w_observacion_ss_tinta
...
String ls_actividad, ls_color_cli
...
on w_observacion_ss_tinta.create
int iCurrent
call super::create
...
on w_observacion_ss_tinta.destroy
call super::destroy
destroy(this.st_1)
...
string text = "Haga doble click para ver la observaci$$HEX1$$f300$$ENDHEX$$n completa"
...
integer width = 3895
integer height = 1144
string dataobject = "d_mu_soli_obs_tinta"
boolean border = true
borderstyle borderstyle = stylelowered!
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Observaciones de las solicitudes de servicio tinta antideslizante de la orden"
end type

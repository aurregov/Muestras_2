HA$PBExportHeader$w_opc_nue_recurso.srw
$PBExportComments$Permite seleccionar adicionalmente un recurso
forward
global type w_opc_nue_recurso from w_response
end type
type cb_buscar from commandbutton within w_opc_nue_recurso
end type
type dw_consulta from u_dw_application within w_opc_nue_recurso
end type
type cb_1 from commandbutton within w_opc_nue_recurso
end type
type cb_aceptar from commandbutton within w_opc_nue_recurso
end type
type dw_1 from u_dw_application within w_opc_nue_recurso
end type
type gb_1 from groupbox within w_opc_nue_recurso
end type
type gb_2 from u_gb_base within w_opc_nue_recurso
end type
end forward
...
global w_opc_nue_recurso w_opc_nue_recurso
...
If Right(a_where,1)=")" Then
	...
	ll_pos=pos(ls_sel1,"dt_medidas_est.co_talla = dt_muestras.co_talla )")
...
iou_param.il_vector[8] = dw_consulta.GetItemNumber(il_fila,"co_recurso")
...
//     ( dt_medidas_est.co_talla = dt_muestras.co_talla )        

is_where="dt_medidas_est.co_talla = dt_muestras.co_talla ) and ("
String ls_cad
...
integer height = 964
integer taborder = 30
string dataobject = "d_muestra_diseno"

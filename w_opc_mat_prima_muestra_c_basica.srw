HA$PBExportHeader$w_opc_mat_prima_muestra_c_basica.srw
$PBExportComments$Para la busqueda de la materia prima de las muestras
forward
global type w_opc_mat_prima_muestra_c_basica from w_response
end type
type mle_nota from multilineedit within w_opc_mat_prima_muestra_c_basica
end type
type cb_buscar from commandbutton within w_opc_mat_prima_muestra_c_basica
end type
type dw_consulta from u_dw_application within w_opc_mat_prima_muestra_c_basica
end type
type cb_1 from commandbutton within w_opc_mat_prima_muestra_c_basica
end type
type cb_aceptar from commandbutton within w_opc_mat_prima_muestra_c_basica
end type
type dw_1 from u_dw_application within w_opc_mat_prima_muestra_c_basica
end type
type gb_1 from groupbox within w_opc_mat_prima_muestra_c_basica
end type
type gb_2 from u_gb_base within w_opc_mat_prima_muestra_c_basica
end type
end forward
...
global w_opc_mat_prima_muestra_c_basica w_opc_mat_prima_muestra_c_basica
...
on w_opc_mat_prima_muestra_c_basica.create
int iCurrent
call super::create
...
on w_opc_mat_prima_muestra_c_basica.destroy
call super::destroy
...
integer height = 964
integer taborder = 30
string dataobject = "d_m_mues1_busq_t1_basica"

HA$PBExportHeader$w_opc_inf_ordenes_proceso.srw
$PBExportComments$Window Class para la b$$HEX1$$fa00$$ENDHEX$$squeda de las $$HEX1$$f300$$ENDHEX$$rdenes que se encuentran en estatdo de proceso.
forward
global type w_opc_inf_ordenes_proceso from w_response
end type
type cb_cancelar from u_cb_application within w_opc_inf_ordenes_proceso
end type
type cb_aceptar from u_cb_application within w_opc_inf_ordenes_proceso
end type
type dw_consulta from u_dw_application within w_opc_inf_ordenes_proceso
end type
type gb_1 from groupbox within w_opc_inf_ordenes_proceso
end type
type gb_2 from groupbox within w_opc_inf_ordenes_proceso
end type
type dw_datos from u_dw_application within w_opc_inf_ordenes_proceso
end type
end forward

global type w_opc_inf_ordenes_proceso from w_response
string tag = "B$$HEX1$$fa00$$ENDHEX$$squeda de $$HEX1$$f300$$ENDHEX$$rdenes - $$HEX1$$d300$$ENDHEX$$rdenes en proceso"
integer width = 1481
integer height = 1072
string title = "B$$HEX1$$fa00$$ENDHEX$$squeda de $$HEX1$$f300$$ENDHEX$$rdenes - $$HEX1$$d300$$ENDHEX$$rdenes en proceso"
...
global w_opc_inf_ordenes_proceso w_opc_inf_ordenes_proceso
...
ls_sel_ini += as_where
clipboard(ls_sel_ini)
//Messagebox('Var','ls_sel_ini='+ls_sel_ini+'~n')
...
lds_consulta.of_load('d_inf_ordenes_proceso')
...
on w_opc_inf_ordenes_proceso.create
int iCurrent
call super::create
...
on w_opc_inf_ordenes_proceso.destroy
call super::destroy
...
If Not IsNull(ls_cad_campo) Then
	...
	is_filtro+="Cliente = "+dw_datos.GetItemString(1,"de_cliente")+", "
End If
...
If Not IsNull(ls_cad_campo) Then
		...
		is_filtro+="Desarrollador = "+dw_datos.GetItemString(1,"de_desarrollador")+", "
End If
...
If Not IsNull(ls_cad_campo) Then
	...
	is_filtro+="Ejecutiva = "+dw_datos.GetItemString(1,"de_ejecutiva")+", "
End If
...
string dataobject = "d_ext_inf_ordenes_proceso"

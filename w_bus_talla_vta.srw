HA$PBExportHeader$w_bus_talla_vta.srw
forward
global type w_bus_talla_vta from w_base_busqueda
end type
end forward

global type w_bus_talla_vta from w_base_busqueda
string title = "B$$HEX1$$fa00$$ENDHEX$$squeda de tallas vta"
end type
global w_bus_talla_vta w_bus_talla_vta
...
public function integer of_retorno ();
io_retorno.il_vector[1] = dw_1.GetItemNumber(il_fila,"co_talla")
io_retorno.is_vector[1] = Trim(dw_1.GetItemString(il_fila,"de_talla"))
Return 1
end function
...
on w_bus_talla_vta.create
call super::create
end on

on w_bus_talla_vta.destroy
call super::destroy
end on
...
// recupera con fab-lin-ref-cal
dw_1.Retrieve(io_param.il_vector[1], io_param.il_vector[2], io_param.il_vector[3], io_param.il_vector[4] )
end event

type sle_1 from w_base_busqueda`sle_1 within w_bus_talla_vta
end type
...
type st_1 from w_base_busqueda`st_1 within w_bus_talla_vta
end type

type cb_aceptar from w_base_busqueda`cb_aceptar within w_bus_talla_vta
end type

type cb_cancelar from w_base_busqueda`cb_cancelar within w_bus_talla_vta
end type

type dw_1 from w_base_busqueda`dw_1 within w_bus_talla_vta
string dataobject = "d_dddw_tallas_vta"
end type

type gb_1 from w_base_busqueda`gb_1 within w_bus_talla_vta
string text = "Lista de tallas"
end type

type gb_2 from w_base_busqueda`gb_2 within w_bus_talla_vta
string text = "Talla"
end type

HA$PBExportHeader$w_mano_obra_ref.srw
$PBExportComments$Para administrar la mano de obra de las referencias en firme
forward
global type w_mano_obra_ref from w_sheet
end type
type dw_log_borradas from u_dw_application within w_mano_obra_ref
end type
type dw_observaciones_60 from u_dw_application within w_mano_obra_ref
end type
type dw_observaciones from u_dw_application within w_mano_obra_ref
end type
type st_1 from statictext within w_mano_obra_ref
end type
type dw_dt_m_proref from u_dw_application within w_mano_obra_ref
end type
type dw_operaciones from u_dw_application within w_mano_obra_ref
end type
type dw_referencia from u_dw_application within w_mano_obra_ref
end type
type gb_referencia from u_gb_base within w_mano_obra_ref
end type
type gb_operaciones from u_gb_base within w_mano_obra_ref
end type
type gb_recurso_adicional from u_gb_base within w_mano_obra_ref
end type
type gb_observaciones from u_gb_base within w_mano_obra_ref
end type
end forward
...
global w_mano_obra_ref w_mano_obra_ref
...
If dw_dt_m_proref.Update(true,false)<>1 Then	
	Return -1
End If

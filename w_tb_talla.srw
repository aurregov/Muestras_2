HA$PBExportHeader$w_tb_talla.srw
forward
global type w_tb_talla from w_simple
end type
end forward
...
integer width = 2971
integer height = 2156
string title = "Mantenimiento de Tallas SAP"
boolean minbox = false
end type
global w_tb_talla w_tb_talla
...
* ----------------------------------------------------------------------------
* Mantenimiento de tallas tb_talla en producto@crypro01 de sabdbs01
* ============================================================================
*/
m_base lm_menu
...
on w_tb_talla.create
call super::create
end on

on w_tb_talla.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_general from w_simple`dw_general within w_tb_talla
integer y = 60
integer width = 2816
integer height = 1876
string dataobject = "dgr_tb_talla"
end type
...
type gb_general from w_simple`gb_general within w_tb_talla
integer x = 27
integer y = 4
integer width = 2898
integer height = 1956

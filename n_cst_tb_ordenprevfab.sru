HA$PBExportHeader$n_cst_tb_ordenprevfab.sru
$PBExportComments$/***********************************************************~r~nSA55583 - Ceiba/jjmonsal - 21-09-2016~r~nComentario: Conexion a Ordenes DB2~r~n***********************************************************/
forward
global type n_cst_tb_ordenprevfab from uo_dsbase
end type
end forward

global type n_cst_tb_ordenprevfab from uo_dsbase
end type
global n_cst_tb_ordenprevfab n_cst_tb_ordenprevfab
...
on n_cst_tb_ordenprevfab.create
call super::create
end on

on n_cst_tb_ordenprevfab.destroy
call super::destroy
end on

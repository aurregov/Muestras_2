HA$PBExportHeader$w_bus_color_pdn.srw
forward
global type w_bus_color_pdn from w_base_busqueda
end type
end forward
...
integer width = 1371
integer height = 1412
string title = "B$$HEX1$$fa00$$ENDHEX$$squeda de Colores pdn"
end type
global w_bus_color_pdn w_bus_color_pdn
...
on w_bus_color_pdn.create
call super::create
end on

on w_bus_color_pdn.destroy
call super::destroy
end on
...
type sle_1 from w_base_busqueda`sle_1 within w_bus_color_pdn
end type
...
type st_1 from w_base_busqueda`st_1 within w_bus_color_pdn
end type

type cb_aceptar from w_base_busqueda`cb_aceptar within w_bus_color_pdn
end type

type cb_cancelar from w_base_busqueda`cb_cancelar within w_bus_color_pdn
end type

type dw_1 from w_base_busqueda`dw_1 within w_bus_color_pdn
integer width = 1147
string dataobject = "d_dddw_colores_pdn"
end type

type gb_1 from w_base_busqueda`gb_1 within w_bus_color_pdn
integer width = 1280
string text = "Lista de Colores Pdn"
end type

type gb_2 from w_base_busqueda`gb_2 within w_bus_color_pdn
integer width = 1280
string text = "Color"
end type

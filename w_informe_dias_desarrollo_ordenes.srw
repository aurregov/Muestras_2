HA$PBExportHeader$w_informe_dias_desarrollo_ordenes.srw
forward
global type w_informe_dias_desarrollo_ordenes from w_sheet
end type
type gb_2 from groupbox within w_informe_dias_desarrollo_ordenes
end type
type cb_1 from commandbutton within w_informe_dias_desarrollo_ordenes
end type
type dw_1 from u_dw_application within w_informe_dias_desarrollo_ordenes
end type
type gb_1 from groupbox within w_informe_dias_desarrollo_ordenes
end type
type dw_fechas from u_dw_application within w_informe_dias_desarrollo_ordenes
end type
type dw_datos from u_dw_application within w_informe_dias_desarrollo_ordenes
end type
end forward
...
integer width = 3045
integer height = 1628
string title = "Informe de d$$HEX1$$ed00$$ENDHEX$$as de desarrollo ordenes"
gb_2 gb_2
cb_1 cb_1
dw_1 dw_1
gb_1 gb_1
...
global w_informe_dias_desarrollo_ordenes w_informe_dias_desarrollo_ordenes
...
of_add("<TD>ESTILO CLIENTE</TD>")

of_add("<TD>DESCRIPCION DESARROLLO</TD>")

of_add("<TD>NUMERO REPETICIONES</TD>")

of_add("<TD>FECHA ORDEN INICIAL</TD>")

of_add("<TD>TIEMPO TOTAL</TD>")

of_add("<TD>CAUSAS REPETICION</TD>")

of_add("<TD>COMPLEMENTO</TD>")
...
//	
   ...
   of_add("<TD>")
	...
	//campo tipo muestra
	of_add("<TD>")
	ls_dato= trim(dw_datos.GetItemString(i,"tipo_muestra"))
	of_add(ls_dato)
	of_add("</TD>")
	
	//campo estilo_cliente
	of_add("<TD>")
	ls_dato= trim(dw_datos.GetItemString(i,"estilo_cliente"))
	of_add(ls_dato)
	of_add("</TD>")

	// campo descripcion_desarrollo
	of_add("<TD>")
	ls_dato= trim(dw_datos.GetItemString(i,"descripcion_desarrollo"))
	of_add(ls_dato)
	of_add("</TD>")
	
	//campo numero_repeticiones
	of_add("<TD>")
	ll_dato=dw_datos.GetItemNumber(i,"numero_repeticiones")
	of_add(String(ll_dato))
	of_add("</TD>")
	
	//campo fecha_orden_inicial
	of_add("<TD>")
	ls_dato=String(dw_datos.GetItemDatetime(i,"fecha_orden_inicial"))
	of_add(ls_dato)
	of_add("</TD>")
	
	//campo tiempo_total
	of_add("<TD>")
	ll_dato=dw_datos.GetItemNumber(i,"tiempo_total")
	of_add(String(ll_dato))
	of_add("</TD>")
	
	// campo causas_repeticion
	of_add("<TD>")
	ls_dato= trim(dw_datos.GetItemString(i,"causas_repeticion"))
	of_add(ls_dato)
	of_add("</TD>")
	
	// campo complemento
	of_add("<TD>")
	ls_dato= trim(dw_datos.GetItemString(i,"complemento"))
	of_add(ls_dato)
	of_add("</TD>")
	...
	//estilo_cliente, descripcion_desarrollo numero_repeticiones fecha_orden_inicial, tiempo_total, causas_repeticion, complemento
	*/
...
on w_informe_dias_desarrollo_ordenes.create
int iCurrent
call super::create
...
on w_informe_dias_desarrollo_ordenes.destroy
call super::destroy
...
integer taborder = 20
boolean bringtotop = true
string dataobject = "d_inf_dias_desarrollo_ordenes"
boolean vscrollbar = false
boolean livescroll = false
end type

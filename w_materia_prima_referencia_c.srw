HA$PBExportHeader$w_materia_prima_referencia_c.srw
$PBExportComments$para la materia prima de la referencia en todos los colores, se hace para una misma talla
forward
global type w_materia_prima_referencia_c from w_sheet
end type
type dw_verifica_color from u_dw_application within w_materia_prima_referencia_c
end type
type dw_colores1 from u_dw_application within w_materia_prima_referencia_c
end type
type rb_un_col from radiobutton within w_materia_prima_referencia_c
end type
type rb_todos_col from radiobutton within w_materia_prima_referencia_c
end type
type dw_partes from u_dw_application within w_materia_prima_referencia_c
end type
type dw_colores from u_dw_application within w_materia_prima_referencia_c
end type
type tab_1 from tab within w_materia_prima_referencia_c
end type
...
type dw_head from u_dw_application within w_materia_prima_referencia_c
end type
type gb_head from u_gb_base within w_materia_prima_referencia_c
end type
type gb_color from u_gb_base within w_materia_prima_referencia_c
end type
type gb_partes from u_gb_base within w_materia_prima_referencia_c
end type
end forward
...
integer width = 3639
integer height = 2136
string title = "Ficha de materia prima de referencias"
string menuname = "m_mat_prima_referencia"
boolean maxbox = true
...
event ue_actualiza_composicion ( )
...
global w_materia_prima_referencia_c w_materia_prima_referencia_c
...
long il_fabrica,il_linea,il_referencia,il_talla,il_calidad,il_diseno,il_color,il_opcion,&
     il_muestrario,il_recurso_tejido
...
decimal lde_FACTOR_MUESTRA_A_PDN
end variables
...
public function integer of_filtro (long al_parte, long al_fila_parte, long al_col, long al_fila_col)
public function integer of_filtrar ()
public function long of_verifica_col (long a_color)
...
public function long of_copiampcol1 (long a_color)
...
public function integer of_recurso_tejido ()
public function integer of_headmod (string a_columna)
public function integer of_recuperar ()
public function integer of_borra_col1 (long a_color)
public function integer of_grabar ()
end prototypes

event ue_borrar_mat_prima();//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Viernes 23 de Mayo de 2003 HORA 14:53:44:390
// 
...
long ll_cant_col
  ...
  DELETE FROM dt_fmp_observacion  
		WHERE ( dt_fmp_observacion.co_fabrica = :il_fabrica ) AND  
				( dt_fmp_observacion.co_linea = :il_linea ) AND  
				( dt_fmp_observacion.co_referencia = :il_referencia ) AND  
				( dt_fmp_observacion.co_talla = :il_talla ) and
				( dt_fmp_observacion.co_calidad = :il_calidad ) and
				( dt_fmp_observacion.co_diseno  = :il_diseno ) and
				( dt_fmp_observacion.co_muestrario = :il_muestrario )
...
event ue_ficha_tecnica();//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Viernes 23 de Mayo de 2003 HORA 11:52:26:109
// 
// 
//////////////////////////////////////////////////////////////////////////
...
lo_param.il_vector[7]=il_muestrario
lo_param.il_vector[8]=il_centro
...
//// 
////////////////////////////////////////////////////////////////////////////
//  SELECT h_preref.co_tipoprod,   
//         h_preref.co_grupo_tlla  
//    INTO :ll_tipo_prod,   
//         :ll_grupo_tlla   
//    FROM h_preref  
//   WHERE ( h_preref.co_fabrica = :il_fabrica ) AND  
//         ( h_preref.co_linea = :il_linea ) AND  
//         ( h_preref.co_referencia = :il_referencia ) 
//	using n_cst_application.itr_appl ;
//
//If n_cst_application.itr_appl.SQLcode=-1 Then 
//	PopulateError(20,"SQL Error")
...
//	MessageBox("Advertencia!","No se encontr$$HEX2$$f3002000$$ENDHEX$$la referencia.",StopSign!)
//	Return
//End If
//
...
//End If
//
OpenSheetWithParm(w_inf_matprima,lo_param,This.ParentWindow(),2,Original!)
...
If rb_todos_col.Checked Then
	MessageBox("Advertencia!","Debe tener seleccionada la opci$$HEX1$$f300$$ENDHEX$$n 'un color'.",StopSign!)
	Return
End If
of_copiamp1()
...
long ll_tot,ll_res_obs,ll_tot_col,ll_pos,ll_f
...
If tab_1.tabpage_1.dw_mp.RowCount()>0 Then
	MessageBox("Advertencia!","La referencia tiene productos de materia prima, solo es posible hacer copia a referencias sin materia prima.",StopSign!)
	Return
End If
...
OpenWithParm(w_opc_mat_prima_c,lou_param)
...
long ll_fabrica,ll_linea,ll_referencia,ll_talla,ll_color,&
     ll_tipoprod,ll_cons,ll_diseno,ll_muestrario,ll_calidad
...
ll_muestrario =  lou_param.il_vector[7]
//////////////////////////////////////////////////////////////////////////
...
If lou_param.is_vector[2]="SINONIMO" Then
	  ...
	  SELECT count(*)  
		 INTO :ll_cant  
		 FROM m_combinaciones_sin 
		WHERE ( m_combinaciones_sin.co_fabrica = :ll_fabrica ) AND  
				( m_combinaciones_sin.co_linea = :ll_linea ) AND  
				( m_combinaciones_sin.co_referencia = :ll_referencia ) AND  
				( m_combinaciones_sin.co_calidad = :ll_calidad ) and 
				( m_combinaciones_sin.co_talla = :ll_talla ) 
				using n_cst_application.itr_appl;
...
Else
	  ...
	  SELECT count(*)  
		...
		WHERE ( m_combinaciones.co_fabrica = :ll_fabrica ) AND  
				( m_combinaciones.co_linea = :ll_linea ) AND  
				( m_combinaciones.co_referencia = :ll_referencia ) AND  
				( m_combinaciones.co_calidad = :ll_calidad ) and 
				( m_combinaciones.co_talla = :ll_talla ) 
				using n_cst_application.itr_appl;
...
If IsNull(ll_cant) Then ll_cant=0
  ...
  SELECT count(*)  
    INTO :ll_cant1  
    FROM m_combinaciones  
   WHERE ( m_combinaciones.co_fabrica = :il_fabrica ) AND  
         ( m_combinaciones.co_linea = :il_linea ) AND  
         ( m_combinaciones.co_referencia = :il_referencia ) AND  
         ( m_combinaciones.co_talla = :il_talla ) 
			using n_cst_application.itr_appl;
...
//////////////////////////////////////////////////////////////////////////
	...
	If lou_param.is_vector[2]="SINONIMO" Then
		lds_v.DataObject="d_verif_combina_ref_sin"
	Else
		lds_v.DataObject="d_verif_combina_ref"
	End If
	
	lds_v.SetTransObject(n_cst_application.itr_appl)
	
	ll_tot=lds_v.Retrieve(ll_fabrica,ll_linea,ll_referencia,ll_calidad,ll_talla,&
	                      il_fabrica,il_linea,il_referencia,il_calidad,il_talla)
	...
	If ll_tot>0 Then
		MessageBox("Advertencia!","Existe diferencia entre las combinaciones de las referencias, "+&
		" la combinaci$$HEX1$$f300$$ENDHEX$$n "+String(lds_v.GetItemNumber(1,"co_combinacion"))+" es "+&
		Trim(lds_v.GetItemString(1,"de_combinacion"))+", en la referencia origen y "+&
...
If lou_param.is_vector[2]="SINONIMO" Then
	lds_1.DataObject="d_h_fmp_1_sin"
Else
...
ll_res=lds_1.Retrieve(ll_fabrica,ll_linea,ll_referencia,ll_talla,ll_calidad,&
                      ll_diseno, ll_muestrario)

If ll_res<=0 Then
	tab_1.tabpage_1.dw_mp.SetRedraw(True)
	dw_partes.SetRedraw(True)
	dw_colores.setredraw(True)
	Destroy lds_1
	MessageBox("Advertencia!","No se encontraron los colores.",StopSign!)
	Return
End If
//////////////////////////////////////////////////////////////////////////
// Solo se muestran los colores que estan en la referencia
// si hay algunos que no existen no se mostraran
//////////////////////////////////////////////////////////////////////////

ll_tot_col=dw_verifica_color.Retrieve(il_fabricaVta,il_lineaVta,il_referenciaVta,il_tallaVta,il_calidadVta)

dw_colores1.Reset()
For i=1 To ll_res
	ll_color=lds_1.GetItemNumber(i,"co_color")
	ll_pos=dw_verifica_color.find("co_color="+String(ll_color),1,ll_tot_col)
	If ll_pos>0 Then
...
For i=1 To ll_res
	ll_color=lds_1.GetItemNumber(i,"co_color")
	ll_pos=dw_colores1.Find("co_color="+String(ll_color)+" and chk=1",1,ll_tot_col)
	
	If ll_pos>0 Then
		ll_f=dw_colores.InsertRow(0)
		
		dw_colores.SetItem(ll_f,"co_color",ll_color)
		dw_colores.SetItem(ll_f,"co_recurso",lds_1.GetItemNumber(i,"co_recurso"))
		dw_colores.SetItem(ll_f,"id_peso",lds_1.GetItemString(i,"id_peso"))
		
		dw_colores.SetItem(ll_f,"co_fabrica",il_fabrica)
		dw_colores.SetItem(ll_f,"co_linea",il_linea)
		dw_colores.SetItem(ll_f,"co_referencia",il_referencia)
		dw_colores.SetItem(ll_f,"co_talla",il_talla)
		dw_colores.SetItem(ll_f,"co_calidad",il_calidad)
		dw_colores.SetItem(ll_f,"co_diseno",il_diseno)
		dw_colores.SetItem(ll_f,"co_muestrario",il_muestrario)

		dw_colores.SetItem(ll_f,'fe_creacion',ldt_fecha)
		dw_colores.SetItem(ll_f,'fe_actualizacion',ldt_fecha)
		dw_colores.SetItem(ll_f,'usuario',ls_usuario)
		dw_colores.SetItem(ll_f,'instancia',ls_instancia)
	End If
...
If lou_param.is_vector[2]="SINONIMO" Then
	  ...
	  INSERT INTO m_combinaciones  
		  ...
		  SELECT :il_fabrica,   
					...
					:il_calidad,
					:il_talla,   
					m_combinaciones_sin.co_combinacion,   
					m_combinaciones_sin.de_combinacion,   
					CURRENT,   
					CURRENT,   
					USER,   
					DBSERVERNAME  
			...
			WHERE ( m_combinaciones_sin.co_fabrica = :ll_fabrica ) AND  
					...
					( m_combinaciones_sin.co_referencia = :ll_referencia ) AND
					( m_combinaciones_sin.co_calidad = :ll_calidad ) and
					( m_combinaciones_sin.co_talla = :ll_talla ) AND  
					( m_combinaciones_sin.co_combinacion not in (  SELECT m_combinaciones.co_combinacion  
																					FROM m_combinaciones  
																				  WHERE ( m_combinaciones.co_fabrica = :il_fabrica ) AND  
																						  ( m_combinaciones.co_linea = :il_linea ) AND  
																						  ( m_combinaciones.co_referencia = :il_referencia ) AND 
																						  ( m_combinaciones.co_calidad = :il_calidad ) and 
																						  ( m_combinaciones.co_talla = :il_talla )  ))   
	using n_cst_application.itr_appl;
...
Else
	  ...
	  INSERT INTO m_combinaciones  
		  ...
		  SELECT :il_fabrica,   
					...
					:il_calidad,
					:il_talla,   
					m_combinaciones.co_combinacion,   
					m_combinaciones.de_combinacion,   
					CURRENT,   
					CURRENT,   
					USER,   
					DBSERVERNAME  
			...
			WHERE ( m_combinaciones.co_fabrica = :ll_fabrica ) AND  
					...
					( m_combinaciones.co_referencia = :ll_referencia ) AND
					( m_combinaciones.co_calidad = :ll_calidad ) and
					( m_combinaciones.co_talla = :ll_talla ) AND  
					( m_combinaciones.co_combinacion not in (  SELECT m_combinaciones.co_combinacion  
																					FROM m_combinaciones  
																				  WHERE ( m_combinaciones.co_fabrica = :il_fabrica ) AND  
																						  ( m_combinaciones.co_linea = :il_linea ) AND  
																						  ( m_combinaciones.co_referencia = :il_referencia ) AND 
...
//////////////////////////////////////////////////////////////////////////
If lou_param.is_vector[2]="SINONIMO" Then
	lds_1.DataObject="d_dt_fmp_c_sin"
Else
...
ll_res=lds_1.Retrieve(ll_fabrica,ll_linea,ll_referencia,ll_talla,&
             ll_calidad, ll_diseno, ll_muestrario)
...
If ll_res<=0 Then
	...
	dw_colores.setredraw(True)
	Destroy lds_1
	MessageBox("Advertencia!","No se ha parametrizado la materia prima para la referencia seleccionada.",StopSign!)
	Return
End If
...
For i=1 To ll_res
	...
	dw_partes.SetItem(i,"co_referencia",il_referencia)
	dw_partes.SetItem(i,"co_talla",il_talla)
	dw_partes.SetItem(i,"co_calidad",il_calidad)
	dw_partes.SetItem(i,"co_diseno",il_diseno)
	dw_partes.SetItem(i,"co_muestrario",il_muestrario)
...
//////////////////////////////////////////////////////////////////////////
If lou_param.is_vector[2]="SINONIMO" Then
	lds_1.DataObject="d_dt_fmp_detalle_c_sin"
Else
...
For i=1 To ll_res
	...
	If ll_pos>0 Then
		ll_f=tab_1.tabpage_1.dw_mp.InsertRow(0)
		
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_color",ll_color)
		
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_centro",lds_1.GetItemNumber(i,"co_centro"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"nu_partemp",lds_1.GetItemNumber(i,"nu_partemp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"nu_mp",lds_1.GetItemNumber(i,"nu_mp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_tipoprod",lds_1.GetItemNumber(i,"co_tipoprod"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_partemp",lds_1.GetItemNumber(i,"co_partemp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_combinacion",lds_1.GetItemNumber(i,"co_combinacion"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_fabrica_mp",lds_1.GetItemNumber(i,"co_fabrica_mp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_producto_mp",lds_1.GetItemNumber(i,"co_producto_mp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"calidad_mp",lds_1.GetItemNumber(i,"calidad_mp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_matiz_mp",lds_1.GetItemNumber(i,"co_matiz_mp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_caracteristi_mp",lds_1.GetItemNumber(i,"co_caracteristi_mp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_color_mp",lds_1.GetItemNumber(i,"co_color_mp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"peso_mp",lds_1.GetItemNumber(i,"peso_mp"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"nu_conos",lds_1.GetItemNumber(i,"nu_conos"))
		
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_proveedor",lds_1.GetItemNumber(i,"co_proveedor"))
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"mp_lote",lds_1.GetItemString(i,"mp_lote"))
		
		
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_fabrica",il_fabrica)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_linea",il_linea)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_referencia",il_referencia)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_talla",il_talla)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_calidad",il_calidad)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_diseno",il_diseno)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,"co_muestrario",il_muestrario)
		
		
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,'fe_creacion',ldt_fecha)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,'fe_actualizacion',ldt_fecha)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,'usuario',ls_usuario)
		tab_1.tabpage_1.dw_mp.SetItem(ll_f,'instancia',ls_instancia)
	End If
Next
...
If dw_partes.RowCount()>0 and dw_colores.RowCount()>0 Then
	of_filtro(dw_partes.GetItemNumber(1,"nu_partemp") /*long al_parte*/,&
					1/*long al_fila*/,&
					dw_colores.GetItemNumber(1,"co_color")/*long al_co_color*/,1)
End If					
...
End If
If lou_param.is_vector[2]="SINONIMO" Then
	lds_1.DataObject="d_dt_fmp_observacion_sin"
Else
...
ids_observacion.SetItem(1,"co_referencia",il_referencia)
ids_observacion.SetItem(1,"co_talla",il_talla)
ids_observacion.SetItem(1,"co_calidad",il_calidad)
ids_observacion.SetItem(1,"co_diseno",il_diseno)
ids_observacion.SetItem(1,"co_muestrario",il_muestrario)
ids_observacion.SetItem(1,"obs_fmp",ls_observacion)


ids_observacion.SetItem(i,'fe_creacion',ldt_fecha)
ids_observacion.SetItem(i,'fe_actualizacion',ldt_fecha)
ids_observacion.SetItem(i,'usuario',ls_usuario)
ids_observacion.SetItem(i,'instancia',ls_instancia)

//////////////////////////////////////////////////////////////////////////
// Se borran los colores que no se referencian
// 
//////////////////////////////////////////////////////////////////////////
...
//
//For i=1 To ll_res
//	If dw_colores1.getItemNUmber(i,"chk")=0 Then
//		ll_color=dw_colores1.GetItemNumber(i,"co_color")
//		of_borra_col1(ll_color)
//		ll_pos=dw_colores.find("co_color="+String(ll_color),1,dw_colores.RowCount())
//		If ll_pos>0 Then
//			dw_colores.deleteRow(ll_pos)
//		End If
//	End If
//Next
//////////////////////////////////////////////////////////////////////////
// Se actualiza la variable que indica cambios en las observaciones
// 
//////////////////////////////////////////////////////////////////////////
...
event ue_copia_todos();//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Miercoles 11 de Junio de 2003 HORA 15:10:46:609
// 
// Copia la materia prima en todos los colores
//////////////////////////////////////////////////////////////////////////
If rb_todos_col.Checked Then
...
event ue_actualiza_composicion();///////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Sabado 02 de Agosto de 2003 HORA 13:30:39:294
// 
// Para la actualizacion de la  composicion
//////////////////////////////////////////////////////////////////////////
...
OpenWithParm(w_actualiza_composicion,lo_param)
end event
...
For i=1 To ll_tot
	...
	tab_1.tabpage_1.dw_mp.SetItem(i,"peso_muestra", lde_peso_prod/lde_FACTOR_MUESTRA_A_PDN)
Next
Return 1
...
If rb_un_col.checked Then
	ls_filtro+=" and co_color= "+String(al_col)
End If
...
public function integer of_referenciaventa ();//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Viernes 30 de Mayo de 2003 HORA 08:54:22:843
// 
// Para determinar la referencia de venta, que es  con la que se manejan los
// colores de la materia prima
//////////////////////////////////////////////////////////////////////////
...
For i=1 To ll_tot
	...
	ElseIf ll_combinacion<>il_COMBINA_GEN Then
		ll_res=lo_c.of_nombrecombinacion( il_fabrica,il_linea,il_Referencia,&
		            il_talla,il_calidad,ll_combinacion, n_cst_application.itr_appl )
	End If
...
ls_filtro="co_color= "+String(ll_col)
...
OpenWithParm(w_color_opcion_ref,lo_param)
...
"Se van a igualar las materias primas y los pesos en todos los colores, esto se hace para la parte seleccionada.~n $$HEX2$$bf002000$$ENDHEX$$Desea continuar ?",Question!,YesNo!,2)
If ll_res=2 Then
	Return 1
End If
...
public function integer of_pesos_x_color ();//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Miercoles 02 de Julio de 2003 HORA 13:48:55:941
// 
// Se actualizan los pesos por colores
//////////////////////////////////////////////////////////////////////////

long i,ll_tot,ll_color,ll_pos
...
lds_1.DataObject="d_peso_x_color_ref"
...
ll_tot=lds_1.retrieve(il_fabrica, il_linea, il_referencia, il_talla, il_calidad, &
               il_diseno, il_muestrario)

For i=1 to ll_tot
	ll_color=lds_1.GetItemNumber(i,"co_color")
	ls_bus="co_color="+String(ll_color)
...
public function integer of_controlmo ();//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Jueves 10 de Julio de 2003 HORA 14:27:39:394
// 
// Se coloca nuevamente la validaci$$HEX1$$f300$$ENDHEX$$n, por sugerencia de Gloria y Lorena S
// Se habia quitado por indicaci$$HEX1$$f300$$ENDHEX$$n de Claudia Chapman
//////////////////////////////////////////////////////////////////////////
...
If dw_head.AcceptText()<>1 Then
	MessageBox("Advertencia!","Datos generales no v$$HEX1$$e100$$ENDHEX$$lidos.",StopSign!)
	Return -1
End If
...
Next
//////////////////////////////////////////////////////////////////////////
// Se hace la verificacion de recursos en mano de obra
// 
//////////////////////////////////////////////////////////////////////////


If of_controlMo()<>1 Then
	MessageBox("Advertencia!","La referencia no tiene recursos asignados para tejido en la mano de obra.",StopSign!)
	//of_iniciar()
	Return -1
End If
...
// Jueves 17 de Febrero de 2005 HORA 16:31:05:953
// 
// Se verifica que el recurso de tejido sea el mismo para todos los colores
//////////////////////////////////////////////////////////////////////////
long ll_recurso,ll_recurso1
ll_tot=dw_colores.Rowcount()

ll_recurso=dw_colores.GetItemNumber(1,"co_recurso")
For i=2 To ll_tot
	ll_recurso1=dw_colores.GetItemNumber(i,"co_recurso")
	If ll_recurso<>ll_recurso1 Then
		MessageBox("Advertencia!","El recurso "+&
		String(ll_recurso)+" es diferente al "+String(ll_recurso1)+" Por favor verifique.",StopSign!)
		Return -1
...
public function integer of_recurso_tejido ();//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Jueves 31 de Julio de 2003 HORA 17:35:32:980
// 
// Para especificar cual es el recurso empleado en tejido en la mano de 
// obra, se coloca por defecto cuando se esta insertando mano de obra en 
// el primer registro.
//
//////////////////////////////////////////////////////////////////////////
...
If IsNull(il_recurso_tejido) Then
	il_recurso_tejido=-1
	Return -1
End If
...
CHOOSE CASE a_columna
	CASE "co_fabrica"
		...
		il_linea=-1
		dw_head.SetItem(1,"co_referencia",ll_null)
		il_referencia=-1
		dw_head.SetItem(1,"de_referencia",ls_null)
		dw_head.SetItem(1,"co_talla",ll_null)
		il_talla=-1
		dw_head.SetItem(1,"de_talla",ls_null)
		il_calidad=1
		dw_head.SetItem(1,"co_calidad",1)
		il_diseno=-1
...
If il_fabrica=-1 or il_linea=-1 or il_referencia=-1 or il_talla=-1 or il_calidad=-1 or &
   il_diseno=-1 or il_muestrario=-1 Then
...
If of_referenciaVenta()<>1 Then
	MessageBox("Advertencia!","No se pudo determinar la referencia de venta.",StopSign!)
	Return -1
End If	
	
ll_tot=dw_head.Retrieve(il_fabrica,il_linea,il_referencia,il_talla,il_calidad,&
       il_diseno, il_muestrario)
...
If ll_tot=0 then
	...
	dw_head.SetItem(1,"co_referencia",il_referencia)
	dw_head.SetItem(1,"co_talla",il_talla)
	dw_head.SetItem(1,"co_calidad",il_calidad)
	dw_head.SetItem(1,"co_diseno",il_diseno)
	dw_head.SetItem(1,"co_muestrario",il_muestrario)
...
If ll_res=1 Then
	dw_head.SetItem(1,"de_referencia",lo_comun.of_getString(1))
	il_tipoprod=lo_comun.of_getLong(1)
End If
//////////////////////////////////////////////////////////////////////////
// Coloco el nombre de la talla y de muestrario y dise$$HEX1$$f100$$ENDHEX$$o
// 
//////////////////////////////////////////////////////////////////////////
...
ll_res=lo_comun.of_nombremuestrario( il_fabrica,il_linea,il_muestrario,&
					 n_cst_application.itr_appl)
...
ll_tot=dw_colores.Retrieve(il_fabrica,il_linea,il_referencia,il_talla,&
                  il_calidad,il_diseno,il_muestrario)
...
ll_tot1=dw_partes.Retrieve(il_fabrica,il_linea,il_referencia,il_talla,&
                  il_calidad,il_diseno,il_muestrario)
If ll_tot1=-1 Then
	Return -1
End If
...
If ll_tot1>0 Then
	...
	ll_res=tab_1.tabpage_1.dw_mp.Retrieve(il_fabrica,il_linea,il_referencia,il_talla,&
	                             il_calidad,il_diseno,il_muestrario)
	...
	If dw_colores.RowCount()>0 Then
		of_filtro(dw_partes.GetItemNumber(ll_tot1,"nu_partemp") /*long al_parte*/,&
...
//////////////////////////////////////////////////////////////////////////
	ll_res=MessageBox("Advertencia!","$$HEX2$$bf002000$$ENDHEX$$Desea copiar la meteria prima de otra referencia ?",Question!,YesNo!,2)
	If ll_res=1 Then
...
ll_tot=ids_observacion.Retrieve(il_fabrica,il_linea,il_referencia,il_talla,&
                       il_calidad,il_diseno,il_muestrario)
...
on w_materia_prima_referencia_c.create
int iCurrent
call super::create
if IsValid(this.MenuID) then destroy(this.MenuID)
if this.MenuName = "m_mat_prima_referencia" then this.MenuID = create m_mat_prima_referencia
...
this.Control[iCurrent+1]=this.dw_verifica_color
this.Control[iCurrent+2]=this.dw_colores1
this.Control[iCurrent+3]=this.rb_un_col
this.Control[iCurrent+4]=this.rb_todos_col
this.Control[iCurrent+5]=this.dw_partes
this.Control[iCurrent+6]=this.dw_colores
this.Control[iCurrent+7]=this.tab_1
this.Control[iCurrent+8]=this.dw_head
this.Control[iCurrent+9]=this.gb_head
this.Control[iCurrent+10]=this.gb_color
this.Control[iCurrent+11]=this.gb_partes
end on

on w_materia_prima_referencia_c.destroy
call super::destroy
...
// JUAN FERNANDO VASQUEZ DUQE 
// Viernes 23 de Mayo de 2003 HORA 15:45:41:734
// 
// Aca se abre la ventana de selecci$$HEX1$$f300$$ENDHEX$$n
//////////////////////////////////////////////////////////////////////////
n_cst_param lo_param

lo_param.is_vector[1]=is_where
lo_param.is_vector[2]="BUSQUEDA"


OpenWithParm(w_opc_mat_prima_c,lo_param)
...
il_referencia =  lo_param.il_vector[3]
il_talla      =  lo_param.il_vector[4]
il_calidad    =  lo_param.il_vector[5]
il_diseno     =  lo_param.il_vector[6]
il_muestrario =  lo_param.il_vector[7]
il_tipoprod   =  lo_param.il_vector[8]
...
Else
	MessageBox("Advertencia!","No se pudo determinar la unidad de referencias",StopSign!)
End If
...
If ll_res=1 Then
	lde_FACTOR_MUESTRA_A_PDN=lo_c.of_getDecimal(1)
	If lde_TAMANO_MUESTRA_FMP<>0 Then
		lde_FACTOR_MUESTRA_A_PDN/=lde_TAMANO_MUESTRA_FMP
	End If
...
If dwo.name="co_combinacion" Then
	...
	OpenWithParm(w_busins_m_combinaciones,lo_param)
...
If dwo.name="co_combinacion" Then
	ll_dato=Long(Data)
	ll_res=lo_c.of_nombreCombinacion( il_fabrica,il_linea, il_referencia,&
	                                  il_talla, il_calidad,ll_dato,n_cst_application.itr_appl)
	If ll_res<>1 Then
...
// JUAN FERNANDO VASQUEZ DUQE 
// Sabado 12 de Abril de 2003 HORA 12:05:45:421
// 
// 
//////////////////////////////////////////////////////////////////////////
...
If il_fila_parte=Row Then Return
...
If dw_colores.RowCount()=0 Then Return

of_filtro(GetItemNumber(row,"nu_partemp"),row,&
...
event itemchanged;call super::itemchanged;//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Sabado 24 de Mayo de 2003 HORA 14:11:36:281
// 
// 
// adicionado para permitir acceder a varios colores al mismo tiempo
// Cada color solo puede estar una vez
//////////////////////////////////////////////////////////////////////////
n_cst_comun lo_comun
Long ll_res,ll_dato,ll_col_old,ll_pos,i
...
//////////////////////////////////////////////////////////////////////////
// se busca el color para verificar que no exista previamente
// 
//////////////////////////////////////////////////////////////////////////
	ll_pos=find("co_color="+data,1,RowCount())
	
	If ll_pos>0 Then
		MessageBox("Advertencia!","El color ya existe y no se puede repetir.",StopSign!)
		Return 2
	End If
	
	If of_verifica_col(ll_col_old)>0 Then
   ...
   ll_res=lo_comun.of_nombreReferenciaColor( il_fabricaVta,il_lineaVta,il_referenciaVta,&
	       il_tallaVta,il_calidadVta,il_color,n_cst_application.itr_appl)
	If ll_res=1 Then	
	...
	Else
		...
		Return 2
	End If	
	SetItem(row,"co_color",il_color)
	If row>1 Then
//////////////////////////////////////////////////////////////////////////
// Se coloca por defecto el recurso de la primera fila
// 
//////////////////////////////////////////////////////////////////////////
		il_recurso_tejido=GetItemNumber(1,"co_recurso")
		
		of_copiaMpCol1(il_color)
	Else
//////////////////////////////////////////////////////////////////////////
// Se coloca por defecto el recurso de tejido en mano de obra
// 
//////////////////////////////////////////////////////////////////////////
		If of_recurso_tejido()<>1 Then
			Return 0
		End If
	End If
	
	SetItem(row,"co_recurso",il_recurso_tejido)
	
	ll_res=lo_comun.of_nombreRecursoTj(il_recurso_tejido,n_cst_application.itr_appl)
...
SetItem(ll_f,"co_muestrario",il_muestrario)
...
event itemfocuschanged;call super::itemfocuschanged;//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Sabado 12 de Abril de 2003 HORA 12:11:57:000
// 
// 
//////////////////////////////////////////////////////////////////////////
...
If il_fila_color=row Then Return
...
If dw_partes.RowCount()=0 or dw_colores.RowCount()=0 Then Return

of_filtro(dw_partes.GetItemNumber(il_fila_parte,"nu_partemp"),il_fila_parte,&
dw_colores.GetItemNumber(Row,"co_color"),&
Row)
...
// JUAN FERNANDO VASQUEZ DUQE 
// Lunes 14 de Abril de 2003 HORA 11:44:12:625
// 
// selecciona color
//////////////////////////////////////////////////////////////////////////
n_cst_param lo_param
...
If dwo.name="co_color" Then
	lo_param.il_vector[1]=il_fabricaVta
	lo_param.il_vector[2]=il_lineaVta
	lo_param.il_vector[3]=il_referenciaVta
	lo_param.il_vector[4]=il_tallaVta
	lo_param.il_vector[5]=il_calidadVta

	OpenWithParm(w_bus_colores_ref,lo_param)
...
integer height = 768
integer taborder = 40
string dataobject = "d_dt_fmp_detalle_c"
boolean hscrollbar = true
boolean livescroll = false
end type
...
If dwo.name="peso_mp" Then
	lde_peso=Dec(Data)
	If lde_FACTOR_MUESTRA_A_PDN<>0 Then
		SetItem(row,"peso_muestra",lde_peso/lde_FACTOR_MUESTRA_A_PDN)
	End If
End If
...
If dwo.name="peso_muestra" Then
	lde_peso=Dec(Data)
	If lde_FACTOR_MUESTRA_A_PDN<>0 Then
		SetItem(row,"peso_mp",lde_peso*lde_FACTOR_MUESTRA_A_PDN)
	End If
End If
...
If dwo.name="co_fabrica_mp" or dwo.name="co_producto_mp" or dwo.name="calidad_mp" or &
...
//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Martes 03 de Junio de 2003 HORA 15:48:57:828
//
// Se coloca la fabrica constante 2
// 
//////////////////////////////////////////////////////////////////////////
...
event clicked;//////////////////////////////////////////////////////////////////////////
// JUAN FERNANDO VASQUEZ DUQE 
// Miercoles 18 de Junio de 2003 HORA 15:04:22:277
// 
// 
//////////////////////////////////////////////////////////////////////////
...
il_referencia,il_talla,il_calidad,il_diseno,il_color,il_muestrario)
end event
...
integer taborder = 50
string title = "none"
string dataobject = "d_resumen_mp_ref_1"
...
CHOOSE CASE dwo.name
	CASE "co_fabrica","co_linea","co_referencia","co_talla","co_calidad","co_diseno", &
		  "co_muestrario"
		If ib_cambios Then
			ll_res=MessageBox("Advertencia!","$$HEX2$$bf002000$$ENDHEX$$Desea descartar los cambios ?",Question!,YesNo!,2)
			If ll_res=2 Then

HA$PBExportHeader$w_opc_mat_prima_muestra_c.srw
$PBExportComments$Para la busqueda de la materia prima de las muestras
forward
global type w_opc_mat_prima_muestra_c from w_response
end type
type mle_nota from multilineedit within w_opc_mat_prima_muestra_c
end type
type cb_buscar from commandbutton within w_opc_mat_prima_muestra_c
end type
type dw_consulta from u_dw_application within w_opc_mat_prima_muestra_c
end type
type cb_1 from commandbutton within w_opc_mat_prima_muestra_c
end type
type cb_aceptar from commandbutton within w_opc_mat_prima_muestra_c
end type
type dw_1 from u_dw_application within w_opc_mat_prima_muestra_c
end type
type gb_1 from groupbox within w_opc_mat_prima_muestra_c
end type
...
global w_opc_mat_prima_muestra_c w_opc_mat_prima_muestra_c
...
//iou_param.il_vector[7] = dw_consulta.GetItemNumber(il_fila,"cnt_opcion")
...
on w_opc_mat_prima_muestra_c.create
int iCurrent
call super::create
...
on w_opc_mat_prima_muestra_c.destroy
call super::destroy
...
integer height = 964
integer taborder = 30
string dataobject = "d_m_mues1_busq_t1"

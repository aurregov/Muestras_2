HA$PBExportHeader$w_matiz.srw
$PBExportComments$Para seleccionar la materia prima
forward
global type w_matiz from w_response
end type
type st_1 from statictext within w_matiz
end type
type sle_1 from singlelineedit within w_matiz
end type
type cb_aceptar from commandbutton within w_matiz
end type
type cb_cancelar from commandbutton within w_matiz
end type
type dw_1 from u_dw_application within w_matiz
end type
type gb_1 from groupbox within w_matiz
end type
type gb_2 from groupbox within w_matiz
end type
end forward
...
event modified;of_filtro("de_matiz like '%"+text+"%'")
dw_1.SetFocus()
end event
...
lo_param.il_vector[1]=dw_1.GetItemNumber(il_fila,"co_matiz")
...
integer width = 1143
integer height = 928
string dataobject = "d_matiz_x_prod"
boolean border = true
borderstyle borderstyle = stylelowered!
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "B$$HEX1$$fa00$$ENDHEX$$squeda Matiz"
borderstyle borderstyle = stylelowered!
end type

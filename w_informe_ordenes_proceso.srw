HA$PBExportHeader$w_informe_ordenes_proceso.srw
forward
global type w_informe_ordenes_proceso from w_sheet
end type
type dw_datos from u_dw_application within w_informe_ordenes_proceso
end type
type cb_1 from commandbutton within w_informe_ordenes_proceso
end type
type dw_1 from u_dw_application within w_informe_ordenes_proceso
end type
type gb_1 from groupbox within w_informe_ordenes_proceso
end type
end forward
...
global w_informe_ordenes_proceso w_informe_ordenes_proceso
...
// FACL - 2019/02/27 - SA59755 - Se agrega Fecha Entrega
of_add("<TD>FECHA ENTREGA</TD>")
...
of_add("<TD>NUMERO DE REPETICIONES</TD>")
...
For i=1 To ll_tot
	...
	of_add("<TD>")
	ls_dato=dw_datos.GetItemString(i,"co_ref_exp")
	of_add(Trim(ls_dato))
	of_add("</TD>")
	...
	// FACL - 2019/02/27 - SA59755 - Se agrega Fecha Entrega
	of_add("<TD>")
	ls_dato=String( dw_datos.GetItemDate(i,"fe_entrega") )
	of_add(Trim(ls_dato))
	of_add("</TD>")
	...
	/*se comenta porque cambia calculo de estos campos 04/02/2021
	of_add("<TD>")
	...
	*/
	...
	//campo dias registro
	of_add("<TD>")
	ll_dato=dw_datos.GetItemNumber(i,"dias_desde_el_registro")
	of_add(String(ll_dato))
	of_add("</TD>")
...
on w_informe_ordenes_proceso.create
int iCurrent
call super::create
...
on w_informe_ordenes_proceso.destroy
call super::destroy
